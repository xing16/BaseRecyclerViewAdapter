package com.xing.baserecycleradapter;
...
public abstract class BaseRecyclerAdapter<T> extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public void removeItem(@IntRange(from = 0) int position) {
        ...
        Log.e("BaseRecycler", "removeItem: internalPosition = " + internalPosition + ", ==== " + (getItemCount() - internalPosition));
        if (position != getItemCount() - 1) {
            notifyItemRangeChanged(internalPosition, getItemCount() - internalPosition);
        }
    }
    ...
    private void print() {
        ...
        Log.e("BaseRecycler", "print: " + sb.toString());
    }
